...
class MainActivity : AppCompatActivity()
{
    ...
    private fun ifWin()
    {
        if(iv1?.tag == iv2?.tag && iv3?.tag == iv1?.tag && iv1?.tag !=null)
        {
            ...
            iv1?.startAnimation(pulse)
            iv2?.startAnimation(pulse)
            iv3?.startAnimation(pulse)
        }
        else if(iv4?.tag == iv5?.tag && iv4?.tag == iv6?.tag && iv4?.tag !=null)
        {
            ...
            iv4?.startAnimation(pulse)
            iv5?.startAnimation(pulse)
            iv6?.startAnimation(pulse)
        }
        else if(iv7?.tag == iv8?.tag && iv7?.tag == iv9?.tag && iv7?.tag !=null)
        {
            ...
            iv7?.startAnimation(pulse)
            iv8?.startAnimation(pulse)
            iv9?.startAnimation(pulse)
        }
